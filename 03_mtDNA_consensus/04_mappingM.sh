...
$GENOME $INPUT_FOLDER/fileTemp_trimmed.fq.gz > $OUTPUT_FOLDER/fileTemp.sam
#$GENOME $INPUT_FOLDER/fileTemp.R1_val_1.fq.gz $INPUT_FOLDER/fileTemp.R2_val_2.fq.gz > $OUTPUT_FOLDER/fileTemp.sam
